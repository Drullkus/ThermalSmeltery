package com.drullkus.thermalsmeltery.common.plugins.tcon.ThermalConstruct.blocks;
...
public class SmelteryMachine extends InventoryBlock
{
    ...
    public SmelteryMachine()
    {
        ...
        this.setBlockName("ThermalSmeltery.Smeltery");
    }
