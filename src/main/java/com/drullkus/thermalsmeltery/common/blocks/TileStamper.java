...
public class TileStamper extends TileSmelteryBase
{
    ...
    public static void initialize() {
        ...
        defaultSideConfigSmeltery[TYPE].numGroup = 3;
        defaultSideConfigSmeltery[TYPE].slotGroups = new int[][]{new int[0], {0, 1}, new int[0]};
        defaultSideConfigSmeltery[TYPE].allowInsertion = new boolean[]{false, false, false};
        defaultSideConfigSmeltery[TYPE].allowExtraction = new boolean[]{false, true, false};
        defaultSideConfigSmeltery[TYPE].sideTex = new int[]{0, 1, 4};
        defaultSideConfigSmeltery[TYPE].defaultSides = new byte[]{(byte)1, (byte)1, (byte)2, (byte)2, (byte)2, (byte)2};
