...
public class GuiStamper extends GuiAugmentableBase
{
    ...
    public void initGui() {
        ...
        this.slotSecondaryInput[0] = (ElementSlotOverlay)this.addElement((new ElementSlotOverlay(this, 55, 47)).setSlotInfo(0, 0, 2));
        this.slotSecondaryInput[1] = (ElementSlotOverlay)this.addElement((new ElementSlotOverlay(this, 55, 47)).setSlotInfo(5, 0, 1));
        ...
        //this.progress = (ElementDualScaled)this.addElement((new ElementDualScaled(this, 79, 34)).setMode(1).setSize(24, 16).setTexture("cofh:textures/gui/elements/Progress_Arrow_Right.png", 48, 16));
