...
public class TConToolModifiers {
    ...
    {
        ModifyBuilder.registerModifier(new ModVoidTouch(new ItemStack[]{new ItemStack(GameRegistry.findItem("ThermalExpansion", "Device"), 1, 0)}, 171));
        TConstructClientRegistry.addEffectRenderMapping(60, "ThermalExpansion", "Device", true);
